...
public class Loops {
    ...
    public static void printCharactersFromAString() {
        String text = "Mpg was beginning to get very tired of sitting by her sister on the bank, and of having nothing to do: once or twice she had peeped into the book...";
